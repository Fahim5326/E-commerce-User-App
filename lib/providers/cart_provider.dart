...
class CartProvider extends ChangeNotifier {
  ...
  Future<void> addtoCart(ProductModel productModel, num priceAfterDiscount) {
    final cartModel = CartModel(productId: productModel.id!, productName: productModel.name,
        imageUrl: productModel.imageUrl, price: priceAfterDiscount,);
  ...
  Future<void> decreaseQuantity(CartModel cartModel) async {
    if(cartModel.quantity > 1) {
      cartModel.quantity -= 1;
      return DbHelper.updateCartQuantity(
